    ...
    <div className="bg-gray-50 dark:bg-gray-900 min-h-screen flex flex-col">
      ...
      <header className="w-full px-6 py-4 flex items-center justify-between bg-white/80 dark:bg-gray-950/80 shadow-sm sticky top-0 z-30 backdrop-blur">
        ...
        <div className="flex gap-2">
          <Link href="/api/auth/signin" className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-semibold shadow transition">Continue with Google</Link>
        </div>
      </header>
      ...
      <section className="flex flex-col items-center justify-center text-center py-20 px-4 bg-gradient-to-b from-white to-blue-50 dark:from-gray-950 dark:to-gray-900">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          <Link href="/api/auth/signin" className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-semibold text-lg shadow transition">Continue with Google</Link>
      ...
      <section className="py-16 px-4 bg-blue-600 dark:bg-blue-800 text-white text-center">
        ...
        <Link href="/api/auth/signin" className="inline-block bg-white text-blue-700 font-semibold px-8 py-3 rounded-lg shadow hover:bg-gray-100 transition text-lg">Continue with Google</Link>
      </section>
